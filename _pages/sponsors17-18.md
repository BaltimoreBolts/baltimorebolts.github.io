            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <a target="_blank" href="https://openworksbmore.org/" class="btn btn-primary w-100 text-light bg-theme">Organization Website</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <a target="_blank" href="https://baltimoreroboticscenter.com/" class="btn btn-primary w-100 text-light bg-theme">Organization Website</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4 sponsor-title">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md">
                        <p class="card-text">TiePoint-bkm is a Baltimore-based engineering firm specializing in designing high-availability data centers.</p>
                        <a target="_blank" href="https://tiepoint.com/" class="btn btn-primary w-100 text-light bg-theme">Organization Website</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="col-md">
        <div class="card mb-4">
            <div class="card-header bg-dark"><h4 class="card-title text-center text-light m-0 p-0 ">Bezos Family Foundation</h4></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md">
                        <img src="/assets/img/Logos/2017-2018/bezos-family-foundation-logo.png" class="d-flex img-fluid mx-auto mb-2 rounded"/>
                        <a href="http://bezonfamilyfoundatation.org" target="_blank" class="btn btn-primary w-100 text-light bg-dark">Organization Website</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md">
                        ...
                        <a href="https://dpattersondesignstudio.com/" target="_blank" class="btn btn-primary w-100 text-dark bg-light">Organization Website</a>
                    </div>
                </div>
            </div>
        </div>
